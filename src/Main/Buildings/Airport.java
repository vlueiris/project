...
public class Airport extends Terminal{
    ...
    private Airport(double constructionCost, String cityName, String terminalName, String address, double meterage, int numVehicle, boolean typeIsInternational, int runwayNum) {
    ...
    public static Airport createAirport(double constructionCost, String cityName, String terminalName, String address,
            double meterage, int numVehicle, boolean typeIsInternational, int runwayNum) {
        return new Airport(constructionCost, cityName, terminalName, address, meterage, numVehicle, typeIsInternational, runwayNum);
    }

...
public abstract class AirVehicle extends Vehicle{
    public static double maxFlightHeight;
    public static double runwayLength; 
    
    
    //constructor
        public AirVehicle(){
//        (double purchasePrice, int capacity, int ID, String companyName, double maxFlightHeight, double runwayLength ) {
        super();
